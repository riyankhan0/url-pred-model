def predict(data_str):
  ...
  try:
    df['URL'] = df['URL'].apply(lambda x: 'http://www.example.com/' + x.split('/', 3)[3])
  except:
    suspicious+=1
  ...
  X = df[['period_count', 'www_count', 'at_count', 'directory_count', 'embedded_domain_count', 'less_than_count', 'open_brace_count', 'close_brace_count', 'plus_count', 'minus_count', 'double_quote_count', 'colon_count', 'semicolon_count', 'asterisk_count', 'backtick_count', 'tilde_count', 'ampersand_count', 'exclamation_count', 'digit_count', 'special_char_count', 'percent_count', 'question_mark_count', 'equal_sign_count', 'url_length', 'iocs_count']]
...
print(predict("https://careers.nadra.gov.pk/ /JobListing/JobApplication?VacancyId=<script>alertt('xss')</script>{\"jtjhpotjgpojg\""))